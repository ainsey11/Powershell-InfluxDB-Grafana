...
$Host1MemUsage = Get-Vmhost "thq-vdi01-01.timicogroup.local"
$Host2MemUsage = Get-Vmhost "thq-vdi01-02.timicogroup.local"
...
$VdiStats.Add($Host1MemUsage.MemoryUsageGB)
$VdiStats.Add($Host2MemUsage.MemoryUsageGB)
...
$body.Add('columns',@('SMBCount','NOCCount', 'DSFreeSpace','host1mem','host2mem'))
